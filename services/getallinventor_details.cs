...
{
    public class getallinventor_details
    {
        dbServices ds = new dbServices();

        public async Task<responseData> Getallinventor_details(requestData rData)
        {
            ...
            try
            {
                ...
                var insertQuery = @"select * from mydb.inventors_data";
