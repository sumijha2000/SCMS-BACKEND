...
namespace COMMON_PROJECT_STRUCTURE_API.services
{
    public class science
    {
        ...
        public async Task<responseData> Science(requestData rData)
        {
            responseData resData = new responseData();
            try
            {
                 var query = @"INSERT INTO mydb.science_data(categories, description, video, video_name) values(@categories, @description, @video, @video_name)";
         ...
         public async Task<responseData> EditScience(requestData rData)
        {
            responseData resData = new responseData();
            try
            {
                var query = @"UPDATE mydb.science_data SET categories=@categories, description=@description, video=@video, video_name=@video_name WHERE idscience_data=@id";
                MySqlParameter[] myParam = new MySqlParameter[]
                {
                    new MySqlParameter("@categories", rData.addInfo["categories"]),
                    new MySqlParameter("@description", rData.addInfo["description"]),
        ...
        public async Task<responseData> DeleteScience(requestData rData)
        {
            responseData resData = new responseData();
            try
            {
                var query = @"DELETE FROM mydb.science_data WHERE idscience_data=@id";
                MySqlParameter[] myParam = new MySqlParameter[]
                {
                    new MySqlParameter("@id", rData.addInfo["id"]),
                };
