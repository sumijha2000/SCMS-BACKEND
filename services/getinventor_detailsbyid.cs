...
{
    public class getinventor_detailsbyid
    {
        dbServices ds = new dbServices();
        public async Task<responseData> Getinventor_detailsbyid(requestData rData)
        {
            ...
            try
            {
                ...
                var idExistsQuery = @"SELECT id FROM mydb.inventors_data WHERE id=@id";
                ...
                if (dbData.Any())
                {
                    ...
                    var query = @"SELECT * FROM mydb.inventors_data WHERE id=@id";
                    ...
                    // Execute SQL query to get data
                    var inventorData = ds.executeSQL(query, myParam).FirstOrDefault();
                    // Adding retrieved data to response

                    resData.rData["inventorData"] = inventorData;
