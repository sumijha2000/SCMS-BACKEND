...
//         public async Task<responseData> Culture(requestData rData)
//         {
//             responseData resData = new responseData();
//             try
//             {
//                  var query = @"INSERT INTO mydb.culture_data(categories, description, video, video_name) values(@categories, @description, @video, @video_name)";
...
namespace COMMON_PROJECT_STRUCTURE_API.services
{
    public class culture
    {
        ...
        public async Task<responseData> EditCulture(requestData rData)
{
    responseData resData = new responseData();
    try
    {
        var query = @"UPDATE mydb.culture_data SET categories=@categories, description=@description, video=@video, video_name=@video_name WHERE idculture_data=@id";
        MySqlParameter[] myParam = new MySqlParameter[]
        {
            new MySqlParameter("@categories", rData.addInfo["categories"]),
            new MySqlParameter("@description", rData.addInfo["description"]),
...
public async Task<responseData> DeleteCulture(requestData rData)
{
    responseData resData = new responseData();
    try
    {
        var query = @"DELETE FROM mydb.culture_data WHERE idculture_data=@id";
        MySqlParameter[] myParam = new MySqlParameter[]
        {
            new MySqlParameter("@id", rData.addInfo["id"]),
        };
