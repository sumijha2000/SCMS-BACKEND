...
namespace COMMON_PROJECT_STRUCTURE_API.services
{
    public class getSupplierData
    {
        ...
        public async Task<responseData> GetSupplierData(requestData rData)
        {
            ...
            try
            {
                ...
                var selectQuery = @"SELECT * FROM mydb.user_account WHERE role = 'supplier'";
                ...
                {
                    resData.rData["rMessage"] = "No Supplier records found";
                }
            }
            catch (Exception ex)
            {
